...
func (c *Client) GetPortalURL(parcelID int64) (string, error) {
	portalResponse := sendcloud.PortalResponse{}
	err := sendcloud.Request("GET", "/api/v2/parcels/"+strconv.Itoa(int(parcelID))+"/return_portal_url", nil, c.apiKey, c.apiSecret, &portalData)
